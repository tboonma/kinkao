...
public class UserServicesConfiguration {
    ...
    private class OAuth2UserServiceImpl extends DefaultOAuth2UserService {
        ...
        public OAuth2User loadUser(OAuth2UserRequest request) throws OAuth2AuthenticationException {
            ...
            try {
                user = new DefaultOAuth2User(new ArrayList<>(), user.getAttributes(), attribute);
    ...
    private class OidcUserServiceImpl extends OidcUserService {
        ...
        public OidcUser loadUser(OidcUserRequest request) throws OAuth2AuthenticationException {
            ...
            try {
                user = new DefaultOidcUser(new ArrayList<>(), user.getIdToken(), user.getUserInfo(), attribute);
            } catch (OAuth2AuthenticationException exception) {
                throw exception;
            }
